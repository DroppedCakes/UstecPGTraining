...
namespace Ustec.WpfHelpers.DialogService.ViewModels
{
    public class ConfirmedMessageBoxViewModel : BindableModelBase, IDialogAware
    {
        #region プロパティ
        ...
        string IDialogAware.Title => this.Title.Value;
        ...
        public ConfirmedMessageBoxViewModel()
        {
            ...
            this.Title = new ReactivePropertySlim<string>("確認");
